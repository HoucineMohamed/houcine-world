  ...
  return (
    <Card className="border-border/50 bg-card/50 backdrop-blur hover:border-tech-blue/50 hover:shadow-lg hover:shadow-tech-blue/20 transition-all duration-300 group hover:scale-[1.02] h-full flex flex-col">
      <CardHeader className="p-2.5 sm:p-4 md:p-6">
        <div className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-tech-blue/10 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:bg-tech-blue/20 transition-colors">
          <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-tech-blue" />
        </div>
      ...
      <CardContent className="flex-1 flex flex-col justify-between p-2.5 sm:p-4 md:p-6 pt-0">
        <div className="space-y-2 sm:space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
            <span className="text-lg sm:text-2xl md:text-3xl font-bold text-tech-blue">
        ...
        <Button 
          className="w-full mt-3 sm:mt-6 bg-tech-blue hover:bg-tech-blue/90 text-xs sm:text-sm py-1.5 sm:py-2"
