      ...
      <main className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        {!loading && !error && repos.length > 0 && (
          <div className="grid md:grid-cols-2 gap-6">
            {repos.map((repo) => (
              <Card key={repo.id} className="border-border/50 bg-card/50 backdrop-blur hover:border-tech-blue/50 transition-all group">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <a
                      ...
                      className="ml-4"
                    >
                      <ExternalLink className="w-5 h-5 text-muted-foreground hover:text-tech-blue transition-colors" />
                    </a>
                  </div>
                </CardHeader>
                <CardContent>
